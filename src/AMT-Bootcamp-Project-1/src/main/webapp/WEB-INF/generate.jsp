<%-- 
  ...
  - Date: October 2017
  - Description: page to generate a random number of cars. A login is requiered.  
  --%>
...
<head>
  ...
  <title>AMT Bootcamp • Generate</title>
  <!-- Bootstrap core CSS-->
      ...
      <div class="row">
        ...
        <div class="col-3">
            ...
            <form method="post" action="${pageContext.request.contextPath}/generate">
                <input class="form-control" type="numeric" placeholder="Number of items" name="nb"><br>
                <input class="btn btn-primary pull-right" type="submit" value="Generate cars">
            </form>
        </div>
      </div>
    </div>
