...
<head>
  ...
  <title>AMT Bootcamp • Dashboard</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <h1>Dashboard</h1>
          <p>Welcome the the world of Cars !</p>
          <p>This webapp let you manage a list of random cars.</p>
          <h2>Statistics</h2>
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">${size} cars in the database</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="cars">
