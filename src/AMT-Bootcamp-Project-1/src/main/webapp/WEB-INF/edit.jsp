<%-- 
  ...
  - Date: October 2017
  - Description: page to edit a specific car  
  --%>
      ...
      <div class="row">
        <div class="col-3">   
            ...
            <c:if test = "${not empty car}">
                ...
                <input class="form-control disabled" type="numeric" placeholder="id" name="id" value="${car.id}" readonly><br>
                <input class="form-control" type="text" placeholder="brand" name="brand" value="${car.brand}"><br>
                <input class="form-control" type="text" placeholder="model" name="model" value="${car.model}"><br>
                <input class="form-control" type="text" placeholder="color" name="color" value="${car.color}"><br>
